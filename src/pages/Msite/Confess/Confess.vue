          ...
          <div class="forum_card">
            ...
            <div class="user_line">
              <div class="user_line_wrap">
                <span class="portrait" v-if="worl.is_anonymity"><img src="" alt=""></span>
                <span class="portrait" v-else><img :src="worl.Cuser['avatar']" alt=""></span>
                <div class="content">
                  <h4 class="title" v-if="worl.is_anonymity">匿名</h4>
                  <h4 class="title" v-else>{{worl.Cuser['nickname']}}</h4>
                  <div class="sub_title">
              ...
              <div class="sudoku" style="width: 349px">
                <div class="sudoku_wrap">
                  ...
                  <viewer  class="img_item" >
                    <img  v-for="(pic, index) in worl.confessionimages_set" :src="pic" :key="index" >
                  </viewer>
  ...
  export default {
    ...
    methods: {
      ...
      upCallback(page) {
        ...
        this.$axios(api+'walls/?page=' + pageNum + "&page_size=" + pageSize).then(data => {
